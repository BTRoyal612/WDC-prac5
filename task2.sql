...
CREATE TABLE `Enrolments` (
  ...
  `subject_code` char(15) DEFAULT NULL,
...
CREATE TABLE `Students` (
  `student_id` char(8) DEFAULT NULL,
  `given_name` char(8) DEFAULT NULL,
  `family_name` char(8) DEFAULT NULL,
...
-- Dump completed on 2022-04-20 10:26:08